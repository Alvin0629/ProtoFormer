...
from configs.demo_flow import get_cfg
...
TRAIN_SIZE = [432, 960] # adjust acording to settings
...
if __name__ == '__main__':
    ...
    parser.add_argument('--end_idx', type=int, default=200)    # ending index of the image sequence
