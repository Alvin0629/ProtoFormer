...
_CN.name = 'depth_VKITTI_pretrain'
_CN.suffix ='vkitti'
_CN.gamma = 0.85
_CN.max_flow = 400
_CN.batch_size = 3
_CN.sum_freq = 200
_CN.val_freq = 10000
_CN.image_size = [368, 800] 
_CN.add_noise = True
_CN.critical_params = []

_CN.transformer = 'latentcostformer'
_CN.restore_ckpt = "checkpoints/sintel_best.pth"
_CN.type = 'depth'
...
_CN.latentcostformer.type = 'depth'
# decoder
...
_CN.trainer.canonical_lr = 10e-5 
_CN.trainer.adamw_decay = 1e-4
_CN.trainer.clip = 1.0
_CN.trainer.num_steps = 140000  
